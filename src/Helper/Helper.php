...
class Helper {
     ...
     * @return array
     */
    public function getMimeFromPronom(string $file): array {
        $reader = new \XMLReader();
        //check the file is a file if not then try the basic xml (DROID_SignatureFile_V100)
        if (!is_file($file) && is_file($file . '/DROID_SignatureFile_V100.xml')) {
            $file = $file . '/DROID_SignatureFile_V100.xml';
        }
